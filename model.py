...
with open('besede.txt') as f:
    for vrstica in f:
        bazen_besed.append(vrstica.strip()) #ta strip pobere ven iz vrstice use tabulatorje, znake za novo vrstico

def nova_igra():
    import random
    izbrana_beseda = random.choice(bazen_besed)
    return  Igra(izbrana_beseda) #to je ime nasega razreda Igra
